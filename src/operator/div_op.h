#ifndef FEATHER_OPERATOR_DIV_OP_H
#define FEATHER_OPERATOR_DIV_OP_H
...
class DivOp : public OpBase {
   public:
    DivOp(std::string name, const BinaryParam& param);
...
#endif  // FEATHER_OPERATOR_DIV_OP_H
