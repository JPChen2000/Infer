#ifndef FEATHER_OPERATOR_TANH_OP_H
#define FEATHER_OPERATOR_TANH_OP_H
...
class TanhOp : public OpBase {
   public:
    TanhOp(std::string name, const UnaryParam& param);
...
#endif  // FEATHER_OPERATOR_TANH_OP_H
