#ifndef FEATHER_OPERATOR_SOFTPLUS_OP_H
#define FEATHER_OPERATOR_SOFTPLUS_OP_H
...
class SoftplusOp : public OpBase {
   public:
    SoftplusOp(std::string name, const UnaryParam& param);
...
#endif  // FEATHER_OPERATOR_SOFTPLUS_OP_H
